...
$pageTitle  = "Ocorrências &middot; Visão Geral"; 
  ...
  if(isset($resultadoRejeitar)){
    if (is_bool($resultadoRejeitar)) {
                echo "<!-- Modal -->
                      <div class='modal fade bs-modal-sm' id='modal_rejeitaOcorrencia' tabindex='-1' role='dialog' aria-labelledby='modal_rejeitaOcorrenciaLabel' aria-hidden='true'>
                        <div class='modal-dialog modal-sm'>
                          <div class='modal-content panel-success'>
                            <div class='modal-header panel-heading'>
                              <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
                              <h4 class='modal-title' id='modal_editOcorrimonioLabel'>Ocorrência assumida!</h4>
                            </div>
                ...
                echo "<!-- Modal -->
                      <div class='modal fade' id='modal_rejeitaOcorrencia' tabindex='-1' role='dialog' aria-labelledby='modal_rejeitaOcorrenciaLabel' aria-hidden='true'>
                        <div class='modal-dialog'>
                          <div class='modal-content panel-danger'>
                            <div class='modal-header panel-heading'>
                              <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
                              <h4 class='modal-title' id='modal_editOcorrimonioLabel'>Não foi possível assumir a ocorrência</h4>
                            </div>
                            <div class='modal-body'>
                              <p>".$resultadoRejeitar."</p>
      ...
      echo "<script>$('#modal_rejeitaOcorrencia').modal('show');</script>";
  }

  if (isset($resultadoAssumir)){
      if (is_bool($resultadoAssumir)) {
                echo "<!-- Modal -->
                      <div class='modal fade bs-modal-sm' id='modal_assumeOcorrencia' tabindex='-1' role='dialog' aria-labelledby='modal_assumeOcorrenciaLabel' aria-hidden='true'>
                        <div class='modal-dialog modal-sm'>
                          <div class='modal-content panel-success'>
                            <div class='modal-header panel-heading'>
                              <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
                ...
                echo "<!-- Modal -->
                      <div class='modal fade' id='modal_assumeOcorrencia' tabindex='-1' role='dialog' aria-labelledby='modal_assumeOcorrenciaLabel' aria-hidden='true'>
                        <div class='modal-dialog'>
                          <div class='modal-content panel-danger'>
                            <div class='modal-header panel-heading'>
                              <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
      ...
      echo "<script>$('#modal_assumeOcorrencia').modal('show');</script>";
  }
