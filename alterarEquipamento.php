        ...
        $result = $editPat->alterarPatrimonio($numPatAntigo, $num_patrimonio, $tipo, $num_posicionamento, $situacao, $lab, $config);
         if (is_bool($result)) {
              echo "<!-- Modal -->
                    ...
                    $LOG->gerarLOG($_SESSION['matricula'], $_SERVER['REMOTE_ADDR'], 'EDIT_EQU', $result);
            }
            else {
              echo "<!-- Modal -->
        ...
        <div class="row">
          <div class="col-lg-3">
           ...
           <div class="col-lg-3">
              ...
              <div class="form-group">
              <select style="font-weight:bold" id="lab" name="lab" value="<?php $lab = $pat->obterDados('Laboratorio_id', $numPatAntigo);?>" class="form-control">
