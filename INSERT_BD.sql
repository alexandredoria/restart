...
INSERT INTO `restart`.`usuario` (`matricula`, `nome`, `sobrenome`, `email`, `senha`, `tipo_usuario`, `data_cadastro`, `data_atualizacao`, `telefone_residencial`, `telefone_celular`, `situacao`, `avatar`) VALUES ('2011', 'Alexandre', 'Dória', 'alexandredoria.01@hotmail.com', '$2Cw51.ICu1Nw', '2', '2014-03-04 00:00:00', '2014-03-06 00:00:00', '(79) 3211-6413', '(79) 9876-5245', '1', 'default_130x130.png');
