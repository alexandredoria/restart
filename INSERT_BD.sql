...
INSERT INTO `restart`.`usuario` (`matricula`, `nome`, `sobrenome`, `email`, `senha`, `tipo_usuario`, `data_cadastro`, `data_atualizacao`, `telefone_residencial`, `telefone_celular`, `situacao`, `avatar`) VALUES ('2011', 'Alexandre', 'Dória', 'sandracostaifs@gmail.com', '$2Cw51.ICu1Nw', '1', CURRENT_TIMESTAMP, NULL, NULL, NULL, '1', 'default_130x130.png');
