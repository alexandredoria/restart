              ...
              <?php
                ...
                if (is_array($result)) {
                  foreach ($result as $row) {
                    if ($row['tipo_laboratorio'] == 2){
                      $tipo = "Bolsista";
                    } if ( $row['tipo_laboratorio'] == 3){
                      $tipo = "Professor";
                    }
                    if($row['data_atualizacao']===null){echo "<tr id='fooTr'class='danger'>";} else echo "<tr id='fooTr'>";
                      echo "
                          <td><input type='checkbox' name='foo[]' id='foo[]' value='".$row['id']."'></td>
				                  <td>
                            <a title='Ver laboratório' href='verLaboratorio.php?m=".$row['id']."' >                              
                              <i class='glyphicon glyphicon-search'></i>
                            </a>
                          </td>
                          <td>
                            <a title='Editar laboratório' href='alterarLaboratorio.php?m=".$row['id']."' >                              
